(function($) {
  ...
  jQuery(document).on("ready", function() {
    ...
    function initMapsNormal() {
      var mapOptions = {
        zoom: 17,
        center: new google.maps.LatLng(23.1885469, 72.6290294),
    ...
    function initMail() {
      $("form#contact-form").on("submit", function(e) {
        ...
        emailjs.send("connect_me", "website_to_me", templateParams, "user_BIvz2sQVgZF2yXgcQaRUh").then(
          function(response) {
            $("div#form-loader").fadeOut(500);
            Materialize.toast(
              "Message Sent! I will contact you shortly, Thanks",
              4000
            );
